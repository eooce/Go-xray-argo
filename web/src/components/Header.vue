<template>
    <el-row>
        <el-col>
            <div style="display: flex; justify-content: flex-end; align-items: center; padding: 8px 0 0 0;">
...
export default {
    ...
    computed: {
        ...
        themeIcon() {
            return this.theme === 'dark' ? 'el-icon-moon' : 'el-icon-sun'
        }
    }
}
</script>
